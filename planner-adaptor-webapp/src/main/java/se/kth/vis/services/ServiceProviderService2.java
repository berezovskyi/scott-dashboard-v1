...
public class ServiceProviderService2
{
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + Nsp1Constants.PATH_PLAN,
        resourceTypes = {Nsp1Constants.TYPE_PLAN},
        usages = {}
    )
    @GET
    @Path("query")
    @Produces({OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON})
    public Plan[] queryPlans(
                                                    ...
                                                    @QueryParam("limit") final String limitString) throws IOException, ServletException
    {
        ...
        final List<Plan> resources = PlannerManager.queryPlans(httpServletRequest, where, page, limit);
        return resources.toArray(new Plan [resources.size()]);
    }

    @GET
    @Path("query")
    @Produces({ MediaType.TEXT_HTML })
    public Response queryPlansAsHtml(
                                    ...
                                    @QueryParam("limit") final String limitString) throws ServletException, IOException
    {
        ...
        // Start of user code queryPlansAsHtml
        // End of user code
        ...
        if (resources!= null) {
            ...
            // Start of user code queryPlansAsHtml_setAttributes
            // End of user code
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/kth/vis/planscollection.jsp");
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final Plan aPlan = PlannerManager.getPlan(httpServletRequest, planId);
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aPlan != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/kth/vis/plan.jsp");
            rd.forward(httpServletRequest,httpServletResponse);
        }
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aPlan != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/kth/vis/plansmallpreview.jsp");
            httpServletResponse.addHeader(PlannerConstants.HDR_OSLC_VERSION, PlannerConstants.OSLC_VERSION_V2);
            rd.forward(httpServletRequest, httpServletResponse);
        }
