    ...
    implements IPlan
{
    ...
    */
    @Deprecated
    public static URI constructURI(final String planId)
    {
    ...
    */
    @Deprecated
    public static Link constructLink(final String planId , final String label)
    {
        return new Link(constructURI(planId), label);
    }
    ...
    */
    @Deprecated
    public static Link constructLink(final String planId)
    {
        return new Link(constructURI(planId));
    }
