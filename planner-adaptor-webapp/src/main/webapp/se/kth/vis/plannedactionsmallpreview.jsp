...
<head>
  ...
  <title><%= aPlannedAction.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>startTime</dt>
            <dd><%= aPlannedAction.startTimeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>endTime</dt>
            <dd><%= aPlannedAction.endTimeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>complete</dt>
            <dd><%= aPlannedAction.completeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>chargeCost</dt>
            <dd><%= aPlannedAction.chargeCostToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>precondition</dt>
            <dd><%= aPlannedAction.preconditionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>effect</dt>
            <dd><%= aPlannedAction.effectToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
