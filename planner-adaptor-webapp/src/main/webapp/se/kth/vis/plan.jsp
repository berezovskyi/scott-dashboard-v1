...
<%@page import="se.kth.vis.resources.Plan"%>
<%--
...
End of user code
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">has</dt>
            <dd class="col-sm-9"><%= aPlan.hasToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">performedBy</dt>
            <dd class="col-sm-9"><%= aPlan.performedByToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
