...
<body>
  ...
  <nav class="navbar sticky-top navbar-light bg-light">
    <div class="container">
      <a class="navbar-brand" href="<c:url value="/services/catalog/singleton"/>">Dashboard</a>
    </div>
  </nav>
...
End of user code
    ...
    (<a href="<%= request.getContextPath() %>/se/kth/vis/selectiondialogsampleclient.jsp?selectionUri=<%= URLEncoder.encode(selectionDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
    ...
    (<a href="<%= request.getContextPath() %>/se/kth/vis/creationdialogsampleclient.jsp?creationUri=<%= URLEncoder.encode(creationDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
