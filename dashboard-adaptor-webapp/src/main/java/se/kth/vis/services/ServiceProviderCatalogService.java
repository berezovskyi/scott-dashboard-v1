...
import se.kth.vis.DashboardConstants;
import se.kth.vis.DashboardManager;
...
public class ServiceProviderCatalogService
{
    ...
    public ServiceProviderCatalog getServiceProviderCatalog()
    {
        ...
        if (catalog != null) {
            httpServletResponse.addHeader(DashboardConstants.HDR_OSLC_VERSION,"2.0");
            return catalog;
        }
    ...
    public void getHtmlServiceProvider(@PathParam("someId") final String someId)
    {
        ...
        if (catalog !=null )
        {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/kth/vis/serviceprovidercatalog.jsp");
            try {
