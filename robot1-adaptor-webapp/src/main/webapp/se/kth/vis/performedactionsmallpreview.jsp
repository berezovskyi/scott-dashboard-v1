...
<head>
  ...
  <title><%= aPerformedAction.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>realizes</dt>
            <dd><%= aPerformedAction.realizesToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>startTime</dt>
            <dd><%= aPerformedAction.startTimeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>endTime</dt>
            <dd><%= aPerformedAction.endTimeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>complete</dt>
            <dd><%= aPerformedAction.completeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>chargeCost</dt>
            <dd><%= aPerformedAction.chargeCostToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>precondition</dt>
            <dd><%= aPerformedAction.preconditionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>effect</dt>
            <dd><%= aPerformedAction.effectToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
