...
public class ServiceProviderService1
{
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + Nsp1Constants.PATH_ROBOT,
        resourceTypes = {Nsp1Constants.TYPE_ROBOT},
        usages = {}
    )
    @GET
    @Path("query")
                                                    ...
                                                    @QueryParam("limit") final String limitString) throws IOException, ServletException
    {
        ...
        final List<Robot> resources = Robot1Manager.queryRobots(httpServletRequest, where, page, limit);
                                    ...
                                    @QueryParam("limit") final String limitString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/kth/vis/robotscollection.jsp");
    ...
    public Robot getRobot(
                @PathParam("robotId") final String robotId
        ) throws IOException, ServletException, URISyntaxException
    {
        // Start of user code getResource_init
        // End of user code

        final Robot aRobot = Robot1Manager.getRobot(httpServletRequest, robotId);
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aRobot != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/kth/vis/robot.jsp");
            rd.forward(httpServletRequest,httpServletResponse);
        }
    ...
    public Compact getRobotCompact(
        @PathParam("robotId") final String robotId
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        // Start of user code getRobotCompact_init
        ...
        if (aRobot != null) {
            ...
            compact.setAbout(aRobot.getAbout());
            compact.setTitle(aRobot.toString());
            ...
            smallPreview.setDocument(UriBuilder.fromUri(aRobot.getAbout()).path("smallPreview").build());
            ...
            largePreview.setDocument(aRobot.getAbout());
    ...
    @GET
    @Path("{robotId}/smallPreview")
    @Produces({ MediaType.TEXT_HTML })
    public void getRobotAsHtmlSmallPreview(
        @PathParam("robotId") final String robotId
        ) throws ServletException, IOException, URISyntaxException
    {
        // Start of user code getRobotAsHtmlSmallPreview_init
        // End of user code
        ...
        if (aRobot != null) {
            httpServletRequest.setAttribute("aRobot", aRobot);
            // Start of user code getRobotAsHtmlSmallPreview_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/se/kth/vis/robotsmallpreview.jsp");
            httpServletResponse.addHeader(Robot1Constants.HDR_OSLC_VERSION, Robot1Constants.OSLC_VERSION_V2);
            rd.forward(httpServletRequest, httpServletResponse);
        }
